...
ifhmm/
	parseihmmlog.pl: parses the Matlab console output by iFHMM, and generates statistics.
	ifhmm.log: the console output of "myexp.m"
	myexp.m: runs iFHMM experiments. has to be put together with iFHMM code
	iFHMMSampler.m: slightly changed from the original file. Please use it to overwrite the old file.
